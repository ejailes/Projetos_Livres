...
type RecentesType = Omit<Recentes, "execute">;

export class Recentes implements Service<LancamentoOUT[]> {
    ...
    execute(): LancamentoOUT[] {
        ...
        return this.conveter.toListLancamentoOUT(this.repoLancamento.recentes(this.conta.getId()));
        
    }

    public static builder(repoLancamentos: Lancamentos, converter: LancamentoConverter) {
        return new Recentes(repoLancamentos, converter) as RecentesType;
    }
}